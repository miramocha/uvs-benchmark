...
> **This fork:** Additional changes on top of Unity **1.9.11** are documented in **[CHANGELOG.enhanced.md](CHANGELOG.enhanced.md)**. Entries below are the upstream Unity Visual Scripting release history (preserved for merge comparison).
