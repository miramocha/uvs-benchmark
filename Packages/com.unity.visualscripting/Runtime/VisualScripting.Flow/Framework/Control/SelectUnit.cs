namespace Unity.VisualScripting
{
    ...
    public sealed class SelectUnit : Unit, ISelectUnit
    {
        ...
        protected override void Definition()
        {
            ...
            selection = ValueOutput(typeof(object), nameof(selection), Branch).Predictable();
        ...
        public ParameterValue Branch(Flow flow)
        {
            return flow.GetValueData(flow.GetValue<bool>(condition) ? ifTrue : ifFalse);
        }
    }
}
