...
namespace Unity.VisualScripting.FullSerializer
{
    ...
    public class fsMetaProperty
    {
        ...
        internal fsMetaProperty(fsConfig config, PropertyInfo property)
        {
            ...
            IsPublic = GetMethod != null && GetMethod.IsPublic && SetMethod != null && SetMethod.IsPublic;
            IsReadOnly = false;
        ...
        public void Write(object context, object value)
        {
            ...
            if (field != null)
            {
                if (PlatformUtility.supportsJit && !IsReadOnly)
                {
            ...
            {
                if (PlatformUtility.supportsJit && CanWrite)
                {
