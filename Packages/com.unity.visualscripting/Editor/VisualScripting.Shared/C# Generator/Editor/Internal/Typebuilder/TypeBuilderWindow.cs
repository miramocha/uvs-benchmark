...
namespace Unity.VisualScripting.Community
{
    public class TypeBuilderWindow : EditorWindow
    {
        ...
        {
            ShowWindowInternal(position, null, result, currentType, canMakeArray, types, onBeforeChanged, onAfterChanged);
        }

        static void ShowWindowInternal(Rect position, Metadata meta, Action<Type> result, Type currentType, bool canMakeArray, Type[] types, Action onBeforeChanged, Action<Type> onAfterChanged)
        {
