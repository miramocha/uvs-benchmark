...
namespace Unity.VisualScripting
{
        ...
        where TDestinationPort : class, IUnitInputPort
    {
        ...
        public override void BeforeRemove()
        {
            ...
            if (destination is ValueInput valueInput)
            {
                valueInput.connectedValueOutput = null;
            }

            if (source is ControlOutput controlOutput)
            {
                controlOutput.connectedControlInput = null;
            }
        }
        ...
        public override bool HandleDependencies()
        {
            ...
            if (destination is ValueInput valueInput && sourceExists && source is ValueOutput valueOutput)
            {
                valueInput.connectedValueOutput = valueOutput;
            }

            if (source is ControlOutput controlOutput && destinationExists && destination is ControlInput controlInput)
            {
                controlOutput.connectedControlInput = controlInput;
            }
