    ...
    public sealed class StructInstanceFunctionInvoker<TTarget, TParam0, TParam1, TParam2, TParam3, TParam4, TReturn> : OptimizedInvokerBase where TTarget : struct
    {
        ...
        public override ParameterValue InvokeRef(ref ParameterValue target, ParameterValue arg0, ParameterValue arg1, ParameterValue arg2, ParameterValue arg3, ParameterValue arg4)
        {
            ...
            if (target.IsBoxed)
            {
                ...
                {
                    return ParameterValue.Create(invoke(ref target.Unbox<TTarget>(), arg0.Cast<TParam0>(), arg1.Cast<TParam1>(), arg2.Cast<TParam2>(), arg3.Cast<TParam3>(), arg4.Cast<TParam4>()));
                }
                else if (target.IsBoxedNumeric)
                {
                    TTarget converted = target.AsNumeric<TTarget>();
                    return ParameterValue.Create(invoke(ref converted, arg0.Cast<TParam0>(), arg1.Cast<TParam1>(), arg2.Cast<TParam2>(), arg3.Cast<TParam3>(), arg4.Cast<TParam4>()));
                }
            }
            ...
            TReturn result = invoke(ref tempTarget, arg0.Cast<TParam0>(), arg1.Cast<TParam1>(), arg2.Cast<TParam2>(), arg3.Cast<TParam3>(), arg4.Cast<TParam4>());
