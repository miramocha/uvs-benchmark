...
namespace Unity.VisualScripting
{
    public sealed class EnumerableCloner : Cloner<IEnumerable>
    {
        ...
        private readonly Dictionary<Type, OptimizedInvokerBase> addMethods = new Dictionary<Type, OptimizedInvokerBase>();

        private OptimizedInvokerBase GetAddMethod(Type type)
        {
