...
{
    public sealed class ConstructorInvoker<TResult, TParam0, TParam1, TParam2, TParam3, TParam4> : ConstructorInvokerBase<TResult>
    {
        ...
        public override object Invoke(object target, object arg0, object arg1, object arg2, object arg3, object arg4)
        {
            if (OptimizedReflection.safeMode)
            {
                ...
                VerifyArgument<TParam4>(constructorInfo, 4, arg4);
        ...
        {
            if (args.Length < 5) throw new IndexOutOfRangeException();

            return InvokeUnsafe(args[0], args[1], args[2], args[3], args[4]);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ParameterValue InvokeUnsafe(ParameterValue arg0, ParameterValue arg1, ParameterValue arg2, ParameterValue arg3, ParameterValue arg4)
        {
        ...
        {
            invoke = Expression.Lambda<Func<TParam0, TParam1, TParam2, TParam3, TParam4, TResult>>(newExpression, parameterExpressions).Compile();
        }
        ...
        protected override void CreateDelegate()
        {
            ...
            {
                return (TResult)constructorInfo.Invoke(new object[] { arg0, arg1, arg2, arg3, arg4 });
            };
        }
    }
}