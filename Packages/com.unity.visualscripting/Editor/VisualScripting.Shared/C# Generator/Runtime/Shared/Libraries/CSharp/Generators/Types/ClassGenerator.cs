...
#pragma warning restore 0414
        ...
        protected override void GenerateBody(CodeWriter writer, ControlGenerationData data)
        {
            ...
            if (fields.Count > 0 && (properties.Count > 0 || methods.Count > 0 || classes.Count > 0 || enums.Count > 0))
                writer.Write("\n\n");
            ...
            if (properties.Count > 0 && (methods.Count > 0 || classes.Count > 0 || enums.Count > 0))
                writer.Write("\n\n");
            ...
            if (methods.Count > 0 && (defferedFieldCount > 0 || classes.Count > 0 || enums.Count > 0))
                writer.Write("\n\n");
