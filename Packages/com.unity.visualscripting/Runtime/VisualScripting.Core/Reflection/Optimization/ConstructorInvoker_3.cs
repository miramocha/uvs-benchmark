...
{
    public sealed class ConstructorInvoker<TResult, TParam0, TParam1, TParam2> : ConstructorInvokerBase<TResult>
    {
        ...
        {
            invoke = Expression.Lambda<Func<TParam0, TParam1, TParam2, TResult>>(newExpression, parameterExpressions).Compile();
        }
        ...
        protected override void CreateDelegate()
        {
            ...
            {
                return (TResult)constructorInfo.Invoke(new object[] { arg0, arg1, arg2 });
            };
        }
    }
}